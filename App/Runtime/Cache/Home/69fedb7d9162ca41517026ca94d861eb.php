						...
						<div class="right_main">
							 <ul id="picUL">
						 		<?php if($list): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="picturea" >
			                            <div class="picture1a" class="highslide-gallery"><a href="__APP__/product/<?php echo ($vo["id"]); ?>"><img src="__ROOT__/__UPLOAD__/im_<?php echo ($vo["img"]); ?>" alt="<?php echo ($vo["title"]); ?>" border="0" onload="AXImg(this,270,210)" /></a>
